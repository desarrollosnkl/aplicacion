...
if(isset($_POST['registrar'])){
    ...
    $consulta= "INSERT INTO contactos (cliente, rif, direccion, fecha, condicion )
    VALUES ('$cliente', '$rif','$direccion','$fecha', '$condicion' )";
            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                            ...
                            <div class="form-group">
                                  <label for="condicion" class="form-label text-white">Condicion:</label>
                                <input type="text"  id="condicion" name="condicion" class="form-control" placeholder="ingrese su condicion" required>
