...
if(isset($_GET['id'])) {
    ...
    $stm = $conexion -> prepare("SELECT * FROM tabla WHERE id=:txtid");
...
$stm = $conexion -> prepare("UPDATE tabla SET cliente=:cliente, rif=:rif, direccion=:direccion, fecha=:fecha WHERE id=:txtid");
